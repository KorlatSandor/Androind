...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String START_MESSAGE = "Találd meg annyi szót, amennyit csak lehet, ami egy betűvel egészül ki.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast toast = Toast.makeText(this, "Nem sikerült betölteni a szótárat", Toast.LENGTH_LONG);
            toast.show();
        }
    }
